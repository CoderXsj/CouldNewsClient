...
import com.icoder.couldnewsclient.view.SplashActivity;
...
public class WelcomeActivity extends FragmentActivity {
    ...
    private HashMap<ImageView, Float> mOriginalXValuesMap = new HashMap<ImageView, Float>();
...
//				Log.d("tedu", "position : " + position + "  positionOffset : " + positionOffset + "  positionOffsetPixels : " + positionOffsetPixels);

                /**
                 * (positionOffset > mPreviousPositionOffset && position == mPreviousPosition)
                 * ��ǰλ�õ�ƫ��������һ�ε�ƫ����Ҫ��,������ͬһ��ҳ����,��Ϊ���󻬶�,
                 */
                if ((positionOffset > mPreviousPositionOffset && position == mPreviousPosition)
                        || (positionOffset < mPreviousPositionOffset && position > mPreviousPosition)) {
            ...
            public void onPageSelected(int position) {
                ...
                for (int i = 0; i < mIndicatorView.length; i++) {
                    mIndicatorView[i]
                            .setBackgroundResource(R.drawable.rounded_cell_gray);
                }
                mIndicatorView[position]
                        .setBackgroundResource(R.drawable.rounded_cell_red);
            }
    ...
    /**
     * ��Ļ�����slidepager������
     * FragmentStatePagerAdapter��FragmentAdapter����PaerAdapter���ӵ�ǿ��
     */
    ...
    private class CustomTransformer implements ViewPager.PageTransformer {
        ...
        public void transformPage(View page, float position) {
            ...
            if (!mViewPagerScrollingLeft
                    && page.findViewById(R.id.center_box_second) != null) {
            ...
            if (position < -1) {
                ...
                if (!mShouldSpheresRotate
                        && page.findViewById(R.id.center_box_third) != null) {
    ...
    private void animateSecondScreen(float position, int pageWidth,
                                     int direction) {
    ...
    public class ScreenSlideFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            ViewGroup rootView = (ViewGroup) inflater.inflate(layoutId,
                    container, false);
            if (position == 0) {
    ...
    private void initFirstScreenViews(View rootView,
    ...
    private void doFadeAnimation() {
        ...
        //���������ͬʱ����
        mAnimatorSet.play(fadeCamcord).with(fadeAudio).with(fadeGraph)
                .with(fadeWordpress).with(fadeClock).with(fadeMap)
                .with(fadeQuote);
        mAnimatorSet.start();
    ...
    private void initSecondScreenViews(View rootView, Bundle savedInstanceState) {
        ...
        final RelativeLayout secondScreenRoot = (RelativeLayout) rootView
                .findViewById(R.id.root);
        // final ImageView
        // centerBox=(ImageView)rootView.findViewById(R.id.center_box_second);
